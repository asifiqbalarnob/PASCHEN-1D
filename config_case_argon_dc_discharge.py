...
Standalone complete configuration for the argon 140 V DC glow-discharge case.
...
The numerical defaults define an argon 140 V DC glow-discharge transient with
a reduced source-side circuit:
...
The case applies 140 V for 40 microseconds to a 2.88 Torr argon gap initialized
at 1.0e14 m^-3. External emission is disabled and ion-induced secondary
emission uses gamma = 0.05. Sweep scripts should override individual fields of
...
#
# This case is loaded with `CONFIG_MODULE = "config_case_argon_dc_discharge"`
# in `run_paschen_1d.ipynb`.
#
...
#
# The defaults reproduce the argon 140 V DC glow-discharge example: a 40 us
# applied step, a 2.88 Torr bare gap, no external emission, and ion-induced
# cathode secondary emission with `gamma = 0.05`.
...
class RunConfig:
    ...
    run_name: str = "argon_dc_glow_discharge_140V"
...
# **Default case**
#
# External emission is disabled for this DC glow-discharge case. The retained
# laser/material fields are inactive unless the corresponding emission toggles
