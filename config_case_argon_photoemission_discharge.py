...
Complete PASCHEN-1D configuration schema for an argon photoemission case.

This module keeps the same full user-facing layout as the generic
configuration file, but its defaults are tuned for an argon photoemission
transient with a reduced source-side circuit:
...
This module is still a complete list of user-facing simulation knobs.
