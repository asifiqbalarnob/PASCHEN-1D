...
Standalone complete configuration for the deuterium nanosecond pulsed discharge.
...
The numerical defaults define a deuterium nanosecond pulsed discharge in a
dielectric-coated gap:

    V_app(t) -- dielectric layers -- plasma gap

The case uses a 20 kV Gaussian drive over 150 ns, 60 Torr deuterium, a
1.0e13 m^-3 initial plasma density, BOLSIG+ D2 electron data, and matched LXCat
D3+/D2 ion mobility and diffusion tables. Sweep scripts should override
...
# `CONFIG_MODULE = "config_case_deuterium_pulsed_discharge"` in
...
#
# The defaults reproduce the deuterium nanosecond pulsed-discharge example: a
# 20 kV Gaussian drive, 60 Torr D2, dielectric-coated electrodes, BOLSIG+ D2
# electron coefficients, and matched LXCat D3+/D2 ion coefficients.
...
class RunConfig:
    ...
    run_name: str = "deuterium_pulsed_discharge"
...
class TownsendCoefficientConfig:
    ...
    townsend_alpha_swarm_data_path: str = "d2_swarm_output_full_EoverN.dat"
...
class IonizationFrequencySourceConfig:
    ...
    # electron_swarm_data). If None, the default electron table is reused:
    # - E/N axis -> local_field_approximation.electron_swarm_data_path
    ionization_frequency_swarm_data_path: str = "d2_swarm_output_full_EoverN.dat"
...
class LocalFieldApproximationConfig:
    ...
    electron_swarm_data_path: str = "d2_swarm_output_full_EoverN.dat"
...
class IonTransportConfig:
    ...
    #   mobility profile
    diffusion_source_mode: IonDiffusionSourceMode = "swarm_data_table_interpolation"
    ...
    mobility_table_path: str | None = "lxcat_606acd7d3f0d4373cf14_reduced_mobility.csv"
    diffusion_table_path: str | None = (
    ...
    gas_temperature_tolerance_K: float = 1.0
...
# **Default case**
#
# External emission is disabled for this deuterium pulsed-discharge case. The
